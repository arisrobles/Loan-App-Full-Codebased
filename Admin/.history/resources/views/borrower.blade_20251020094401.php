...
@section('head')
  ...
  <style>
    ...
    /* Cards (mobile) */
    .cards-section article{box-shadow:0 8px 16px -12px rgba(2,6,23,.12)}
    .cards-section{padding-bottom:1rem}

    /* Accessibility focus */
    tr:focus-within td{outline:2px solid #4f46e5;outline-offset:-2px}
  </style>
@endsection
      ...
      <div class="flex items-center gap-2">
        ...
        <div data-menu>
          ...
          <div class="menu absolute right-0 mt-2 bg-white border border-slate-200 rounded-xl shadow-soft hidden">
            ...
            <button class="block w-full text-left px-3 py-2 hover:bg-slate-50" onclick="toggleDensity()">Compact Density</button>
      ...
      <form action="{{ route('borrowers.index') }}" method="GET" class="grid grid-cols-1 lg:grid-cols-12 gap-3 items-end">
        <div class="lg:col-span-4">
          ...
          <div class="relative">
            ...
            <svg class="h-4 w-4 absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" viewBox="0 0 24 24" fill="none" stroke="currentColor">
...
{{-- Flash + Bulk Bar omitted for brevity; keep your existing content here --}}
...
{{-- Create / Edit modals + toast same as your original (no changes needed) --}}
@endsection
