...
@section('title', 'Documents — MasterFunds')
...
@section('content')
  ...
  <div class="bg-white/90 backdrop-blur border border-slate-200 rounded-xl mb-6">
    <div class="px-4 md:px-6 py-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
      <div class="sm:col-span-2">
        <div class="relative">
          <input id="search" name="q" class="h-10 w-full pl-9 pr-3 rounded-lg bg-slate-100 text-sm outline-none"
                 placeholder="Search document title / type / owner (Press / to focus)">
      ...
      <div class="flex gap-2">
        <button class="btn btn-quiet w-full" onclick="window.location.href='{{ route('documents.index') }}'">Reset</button>
        <button id="newDocBtn" class="btn btn-primary w-full">Upload</button>
      </div>
    </div>
  </div>
  ...
  <section class="bg-white p-6 rounded-2xl shadow-card border border-slate-100">
    <h2 class="text-base md:text-lg font-semibold">Documents Summary</h2>
    <p class="text-slate-600 text-sm mt-1">Overview of stored and categorized documents.</p>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
      <article class="rounded-xl border border-slate-200 p-4 bg-slate-50/50">
        ...
        <div class="mt-1 text-xl font-semibold text-indigo-600">128</div>
      </article>
      <article class="rounded-xl border border-slate-200 p-4 bg-slate-50/50">
        <div class="text-sm text-slate-500">Contracts</div>
        <div class="mt-1 text-xl font-semibold text-emerald-600">34</div>
      </article>
      <article class="rounded-xl border border-slate-200 p-4 bg-slate-50/50">
        <div class="text-sm text-slate-500">Invoices</div>
        <div class="mt-1 text-xl font-semibold text-amber-600">57</div>
      </article>
      <article class="rounded-xl border border-slate-200 p-4 bg-slate-50/50">
        <div class="text-sm text-slate-500">Receipts</div>
        <div class="mt-1 text-xl font-semibold text-slate-700">37</div>
      </article>
    </div>
  </section>
  ...
  <section class="bg-white p-6 rounded-2xl shadow-card border border-slate-100 mt-6">
    <div class="flex items-center justify-between mb-4">
      <h2 class="text-base md:text-lg font-semibold">Document Records</h2>
    ...
    <div class="overflow-x-auto rounded-xl border border-slate-100">
      <table class="min-w-[900px] w-full text-sm table-sticky">
        ...
        <tbody class="divide-y divide-slate-100">
          <tr class="hover:bg-slate-50">
            <td class="p-3">1</td>
            <td class="p-3 truncate max-w-[220px]">Loan Agreement — Juan Dela Cruz</td>
            <td class="p-3">Contract</td>
            <td class="p-3">Admin</td>
            <td class="p-3">2025-10-18</td>
            <td class="p-3"><span class="badge bg-emerald-100 text-emerald-700">Active</span></td>
            <td class="p-3">
              <details class="relative">
                ...
                <div class="absolute z-20 mt-1 w-40 bg-white border border-slate-200 rounded-lg shadow-card p-2">
                  <button class="w-full text-left px-3 py-2 rounded hover:bg-slate-50 text-indigo-700">View</button>
                  <button class="w-full text-left px-3 py-2 rounded hover:bg-slate-50 text-amber-700">Download</button>
                  <button class="w-full text-left px-3 py-2 rounded hover:bg-slate-50 text-rose-700">Delete</button>
                </div>
              </details>
            </td>
          </tr>
          <tr class="hover:bg-slate-50">
            <td class="p-3">2</td>
            <td class="p-3 truncate max-w-[220px]">Monthly Collection Report</td>
            <td class="p-3">Report</td>
            <td class="p-3">Finance Officer</td>
            <td class="p-3">2025-10-12</td>
            <td class="p-3"><span class="badge bg-slate-100 text-slate-700">Archived</span></td>
            <td class="p-3">
              <details class="relative">
                <summary class="list-none cursor-pointer px-3 h-9 rounded border border-slate-200 hover:bg-slate-50 inline-flex items-center">Actions ▾</summary>
                <div class="absolute z-20 mt-1 w-40 bg-white border border-slate-200 rounded-lg shadow-card p-2">
          ...
          <tr><td colspan="7" class="p-8 text-center text-slate-500 text-sm">End of sample data</td></tr>
        </tbody>
      </table>
    </div>
  </section>
