        ...
        <tbody class="divide-y divide-slate-100">
          @forelse($transactions as $i=>$tx)
            ...
            <tr class="hover:bg-slate-50">
              ...
              <td class="p-3">
                @if($st==='posted')<span class="badge bg-emerald-100 text-emerald-700">Posted</span>
                @elseif($st==='excluded')<span class="badge bg-slate-100 text-slate-700">Excluded</span>
                @else<span class="badge bg-amber-100 text-amber-700">Pending</span>@endif
              </td>
